...
class Config:
    ...
    CHANNEL_RATE_WINDOW = 60
    CHANNEL_RATE_FLOOR = 8
    CHANNEL_SPIKE_MULTIPLIER = 4
    CHANNEL_BASELINE_ALPHA = 0.05
    CHANNEL_RAID_COOLDOWN = 300
    CHANNEL_MIN_SCORE = 2
    CHANNEL_SEQ_ID_GAP = 50000
    CHANNEL_SEQ_ID_CLUSTER = 3
